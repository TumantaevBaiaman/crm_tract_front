                                            ...
                                            <div data-repeater-item className="outer">
                                                <FormGroup className="mb-4" row>
                                                  <Label
                                                    ...
                                                    ) : isMobile ? null: <button className={"btn info_new"+color_btn()} id="inputGroupFileAddon03" data-title="Need an phone1 to register"><i className="mdi mdi-alert-circle-outline"></i></button>}
                                                        </div>
                                                    </Col>
                                                </FormGroup>
                                            </div>
                                            ...
                                            <div data-repeater-item className="outer">
                                                <FormGroup className="mb-4" row>
                                                  <Label
                                                    ...
                                                    />
                                                            {isMobile ? null:<button className={"btn info_new"+color_btn()} id="inputGroupFileAddon03" data-title="Need an phone2 to register"><i className="mdi mdi-alert-circle-outline"></i></button>}
                                                        </div>
                                                    </Col>
                                                </FormGroup>
                                            </div>
